...
func (c *Controller) Reconcile(ctx context.Context) (reconcile.Result, error) {
	...
	providerIDCloudProviderNodeClaimMap := make(map[string]*corev1beta1.NodeClaim, len(cloudProviderNodeClaims))
	...
	for i := range nodeClaimList.Items {
		...
		nodeClaim.Labels = lo.Assign(nodeClaim.Labels, map[string]string{
			v1beta1.LabelCapactiyReservationID: cloudProviderNodeClaim.Labels[v1beta1.LabelCapactiyReservationID],
		})
