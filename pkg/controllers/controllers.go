...
import (
	...
	nodeclaimcapacityreservation "github.com/aws/karpenter-provider-aws/pkg/controllers/nodeclaim/capacityreservation"
...
func NewControllers(
	...
	controllers := []controller.Controller{
		...
		nodeclaimcapacityreservation.NewController(kubeClient, cloudProvider),
